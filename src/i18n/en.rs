...
pub fn ui_strings() -> HashMap<String, String> {
    [
        ...
        ("costume.prev", "Previous costume"),
        ("costume.next", "Next costume"),
        ("infobox.copy", "Copy value"),
        ("infobox.copied", "Copied!"),
        ("image.zoom", "Zoom"),
        ...
        ("floating.collapse", "Collapse floating bar"),
        ("floating.expand", "Expand floating bar"),
